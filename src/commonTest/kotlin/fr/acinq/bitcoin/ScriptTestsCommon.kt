...
class ScriptTestsCommon {
    ...
    fun p2pkh() {
        ...
        assertEquals("FgG93xfPdyyT4eeT6gmPM6dyyg7fSrTjMi", Bitcoin.addressFromPublicKeyScript(Block.LivenetGenesisBlock.hash, script))
    }
    ...
    fun p2sh() {
        ...
        assertEquals("3DedZ8SErqfunkjqnv8Pta1MKgEuEFom7e", Bitcoin.addressFromPublicKeyScript(Block.LivenetGenesisBlock.hash, script))
    }
    ...
    fun p2wpkh() {
        ...
        assertEquals("grs1q0xcqpzrky6eff2g52qdye53xkk9jxkvr2tcka0", Bitcoin.addressFromPublicKeyScript(Block.LivenetGenesisBlock.hash, script))
    }
    ...
    fun p2wsh() {
        ...
        assertEquals("grs1qdudnf8tla4fyptt3n9y9985tq64lqwzr37d4ywpqfzfhtt638gls0xxpuz", Bitcoin.addressFromPublicKeyScript(Block.LivenetGenesisBlock.hash, script))
    }
    ...
    fun `future segwit versions`() {
        ...
        assertEquals("grs1p0xlxvlhemja6c4dqv22uapctqupfhlxm9h8z3k2e72q4k9hcz7vqddt7at", Bitcoin.addressFromPublicKeyScript(Block.LivenetGenesisBlock.hash, script))
    }
