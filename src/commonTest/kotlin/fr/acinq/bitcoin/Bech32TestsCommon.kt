...
class Bech32TestsCommon {
    ...
    fun `create addresses`() {
        assertEquals(Bech32.encodeWitnessAddress("grs", 0, Hex.decode("751e76e8199196d454941c45d1b3a323f1433bd6")), "GRS1QW508D6QEJXTDG4Y5R3ZARVARY0C5XW7K3K4SJ5".lowercase())
        assertEquals(Bech32.encodeWitnessAddress("grs", 1, Hex.decode("79be667ef9dcbbac55a06295ce870b07029bfcdb2dce28d959f2815b16f81798")), "grs1p0xlxvlhemja6c4dqv22uapctqupfhlxm9h8z3k2e72q4k9hcz7vqddt7at")
        assertEquals(Bech32.encodeWitnessAddress("tgrs", 0, Hex.decode("1863143c14c5166804bd19203356da136c985678cd4d27a1b8c6329604903262")), "tgrs1qrp33g0q5c5txsp9arysrx4k6zdkfs4nce4xj0gdcccefvpysxf3quvjfuq")
        assertEquals(Bech32.encodeWitnessAddress("tgrs", 0, Hex.decode("000000c4a5cad46221b2a187905e5266362b99d5e91c6ce24d165dab93e86433")), "tgrs1qqqqqp399et2xygdj5xreqhjjvcmzhxw4aywxecjdzew6hylgvsess668a6")
        assertEquals(Bech32.encodeWitnessAddress("tgrs", 1, Hex.decode("000000c4a5cad46221b2a187905e5266362b99d5e91c6ce24d165dab93e86433")), "tgrs1pqqqqp399et2xygdj5xreqhjjvcmzhxw4aywxecjdzew6hylgvses6d6w9x")
    }
